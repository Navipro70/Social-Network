...
describe('Status component basic tests', () => {
  const component = create(
    <StatusHook isOwner={true} statusText={'SomeText'} setStatus={thunkSetStatus} />,
  ).root
...
describe('Status component tests with special props', () => {
  const component = create(
    <StatusHook isOwner={false} statusText={''} setStatus={thunkSetStatus} />,
  ).root
  ...
  test('Check span text, when status is empty string and no Owner person', () => {
    const component = create(
      <StatusHook isOwner={true} statusText={''} setStatus={thunkSetStatus} />,
