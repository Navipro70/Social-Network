...
let initialState = {
  posts: [
    {postText:  "ПОМЕНЯТЬ ПРЕЛОАДЕР, ЧТОБЫ ЛОВИТЬ ОШИБКУ С БЭКА ПРИ ИЗМЕНЕНИИ СТАТУСА НЕ НУЖНО ДЕЛАТЬ НОВЫЙ ЗАПРОС НА СЕРВЕР, А НУЖНО ПОМЕНЯТЬ ДАННЫЕ В ПРОФИЛЕ, ИСПРАВИТЬ! ПОСМОТРЕТЬ ЧТО МОЖНО СДЕЛАТЬ С ПОЛЯМИ FIELDS, ВЫНЕСТИ ИХ В ОТДЕЛЬНУЮ ФУНКЦИЮ И ПОМЕНЯТЬ ИХ ВЕЗДЕ", id: 1},
    {postText: "ПОМЕНЯТЬ ПРЕЛОАДЕР, ЧТОБЫ ЛОВИТЬ ОШИБКУ С БЭКА ПРИ ИЗМЕНЕНИИ СТАТУСА НЕ НУЖНО ДЕЛАТЬ НОВЫЙ ЗАПРОС НА СЕРВЕР, А НУЖНО ПОМЕНЯТЬ ДАННЫЕ В ПРОФИЛЕ, ИСПРАВИТЬ! ПОСМОТРЕТЬ ЧТО МОЖНО СДЕЛАТЬ С ПОЛЯМИ FIELDS, ВЫНЕСТИ ИХ В ОТДЕЛЬНУЮ ФУНКЦИЮ И ПОМЕНЯТЬ ИХ ВЕЗДЕ", id: 2},
    {postText: "ПОМЕНЯТЬ ПРЕЛОАДЕР,  ЧТОБЫ ЛОВИТЬ ОШИБКУ С БЭКА ПРИ ИЗМЕНЕНИИ СТАТУСА НЕ НУЖНО ДЕЛАТЬ НОВЫЙ ЗАПРОС НА СЕРВЕР, А НУЖНО ПОМЕНЯТЬ ДАННЫЕ В ПРОФИЛЕ, ИСПРАВИТЬ! ПОСМОТРЕТЬ ЧТО МОЖНО СДЕЛАТЬ С ПОЛЯМИ FIELDS, ВЫНЕСТИ ИХ В ОТДЕЛЬНУЮ ФУНКЦИЮ И ПОМЕНЯТЬ ИХ ВЕЗДЕ", id: 3}
  ],
  profile: null,
